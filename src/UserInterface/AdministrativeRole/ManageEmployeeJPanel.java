...
public class ManageEmployeeJPanel extends javax.swing.JPanel {
   ...
   public ManageEmployeeJPanel(JPanel userProcessContainer, OrganizationDirectory organizationDirectory,Enterprise enterprise) {
    ...
    private void initComponents() {
        ...
        organizationEmpJComboBox.setBounds(280, 70, 120, 30);

        jLabel3.setText("Organization");
        add(jLabel3);
        jLabel3.setBounds(190, 70, 80, 30);
        ...
        add(backJButton);
        backJButton.setBounds(66, 466, 73, 23);
        ...
        add(addEmployee);
        addEmployee.setBounds(480, 230, 120, 30);
