...
public class ViewOrgansAvailableJPanel extends javax.swing.JPanel {
   ...
   public ViewOrgansAvailableJPanel(JPanel userProcessContainer, UserAccount userAccount, OrganBankOrg organization, EcoSystem ecosystem) {
    initComponents();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(10, 110, 891, 224);
        ...
        add(refreshBtn);
        refreshBtn.setBounds(750, 10, 164, 39);
    ...
    private String OrganAvailableRequest(WorkRequest r) {
