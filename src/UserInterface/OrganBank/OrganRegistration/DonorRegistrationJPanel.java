...
public class DonorRegistrationJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(registerBtn);
        registerBtn.setBounds(230, 900, 120, 30);
        ...
        add(agreeCheckBox);
        agreeCheckBox.setBounds(180, 750, 291, 23);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(180, 780, 463, 87);
        ...
        add(heartCheckBox);
        heartCheckBox.setBounds(180, 680, 66, 23);

        liverCheckBox.setText("Liver");
        add(liverCheckBox);
        liverCheckBox.setBounds(310, 680, 62, 23);

        lungsCheckBox.setText("Both lungs");
        add(lungsCheckBox);
        lungsCheckBox.setBounds(180, 710, 99, 23);

        pancreasCheckBox.setText("Pancreas");
        add(pancreasCheckBox);
        pancreasCheckBox.setBounds(310, 710, 87, 23);

        kidneyCheckBox.setText("Both Kidneys");
        add(kidneyCheckBox);
        kidneyCheckBox.setBounds(420, 680, 113, 23);

        intestineCheckBox.setText("Intestines");
        add(intestineCheckBox);
        intestineCheckBox.setBounds(420, 710, 106, 23);
        ...
        add(withdrawBtn);
        withdrawBtn.setBounds(490, 900, 120, 30);
        ...
        add(firstnameLbl4);
        firstnameLbl4.setBounds(170, 530, 90, 30);
        ...
        add(emergencyNoTxt);
        emergencyNoTxt.setBounds(400, 630, 230, 30);
    ...
    private void medicalIdTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_medicalIdTxtActionPerformed
        ...
        int check=0;
        for(OrganDonor od : odd.getOrganDonorList()){
            if(medicalIdTxt.equals(od.getMedicalID())){
                registerBtn.setVisible(false);
                checkAlreadyDonor=1;
    ...
    private void heartCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_heartCheckBoxActionPerformed
     ...
     private void populateStateComboBox() {
      ...
      private OrganDonor addOrgans(OrganDonor od) {
          if(heartCheckBox.isSelected()){ od.getOrgans().add("Heart");} 
          if(liverCheckBox.isSelected() ){ od.getOrgans().add("Liver");}
          if(pancreasCheckBox.isSelected()) { od.getOrgans().add("Pancreas");}
          if(intestineCheckBox.isSelected()){ od.getOrgans().add("Intestine");}
          if(kidneyCheckBox.isSelected()){ od.getOrgans().add("L.Kidney"); od.getOrgans().add("R.Kidney");}
          if(lungsCheckBox.isSelected()){ od.getOrgans().add("L.Lung"); od.getOrgans().add("R.Lung");}
          return od;
