...
public class AddMedicalIdWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        regNumTxt = new javax.swing.JTextField();
        ...
        regisLbl.setText("Blood Group:");
        add(regisLbl);
        regisLbl.setBounds(750, 360, 140, 30);
        add(medicalIdTxt);
        ...
        add(generateId2);
        generateId2.setBounds(560, 630, 120, 30);
        ...
        add(addrLbl);
        addrLbl.setBounds(160, 520, 100, 30);
        ...
        regNumTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                regNumTxtActionPerformed(evt);
            }
        });
        add(regNumTxt);
        regNumTxt.setBounds(920, 360, 160, 30);
        ...
        add(addressTxt);
        addressTxt.setBounds(310, 520, 160, 30);
        ...
        add(jButton1);
        jButton1.setBounds(350, 230, 110, 40);
        ...
        add(bloodGrpLbl);
        bloodGrpLbl.setBounds(140, 480, 120, 30);
        ...
        bloodGrpComboBox.setBounds(310, 480, 96, 27);
    ...
    private void generateId2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateId2ActionPerformed
        ...
        medicalId.setFirstName(firstnameTxt.getText());
        medicalId.setLastName(lastNameTxt.getText());
        medicalId.setMotherName(motherNameTxt.getText());
        medicalId.setFatherName(fatherName.getText());
       // m.setDateOfBirth(DobTxt.getText());
        medicalId.setAddress(addressTxt.getText());
        medicalId.setPlaceOfBirth(placeOfBTxt.getText());

        medicalId.setRegistrationNum(regNumTxt.getText());
        medicalId.setBloodGroup(bloodGrpComboBox.getSelectedItem().toString());

        medicalId.setSex(sexTxt.getText());
            medicalId.setMedicalId(Integer.parseInt(medicalIdTxt.getText()));
    ...
    private void regNumTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regNumTxtActionPerformed
        pathTxt.setText("");
    }//GEN-LAST:event_regNumTxtActionPerformed
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\Niranjanii\\Documents\\test.pdf"));
            document.open();
//            JPanel jpanel = new JPanel();
//            jpanel.add(firstnameTxt);
//            jpanel.add(lastNameTxt);
...
//            contentByte.addTemplate(template, 30, 300);
                ...
                document.add(new Paragraph(firstnameTxt.getText()));
                 //step 5
                document.close();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private javax.swing.JTextField regNumTxt;
